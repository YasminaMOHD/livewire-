                                            ...
                                            <td style="text-align: center">
                                                ...
                                                @if ($work->status == 3)
                                                    <span class="text-danger mb-2"> مرفوضة <span>
                                                            <br>
                                                    <span class="show-more" style="color: blue">اظهار سبب الرفض...</span>
                                                    <br>
                                                    <span class="reject-reason" style="display: none" class="w-100">
                                                        {{$work->reject_reason}}
                                                    </span>
                                                @endif
                                            </td>
    ...
    @push('scripts')
        <script>
            ...
            $(document).on('click','.show-more',function(){
                $(this).parent().find('.reject-reason').fadeToggle();
            })
        </script>
    @endpush
</div>
