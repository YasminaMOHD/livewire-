        ...
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:{{ asset('dist/assets//media/svg/icons/General/User.svg') }}')}}-->
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol  mr-5">
                    <div class="symbol-label"
                        style="background-image:url('{{ asset('dist/assets//media/users/default.jpg') }}')"></div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        <a href="mail:{{ Auth::user()->email }}" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                <span class="navi-icon mr-1">
                                    <span class="svg-icon svg-icon-lg svg-icon-primary">
                                        <!--begin::Svg Icon | path:{{ asset('dist/assets//media/svg/icons/Communication/Mail-notification.svg') }}-->
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-success">
                                    <!--begin::Svg Icon | path:{{ asset('dist/assets//media/svg/icons/General/Notification2.svg') }}-->
							...
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<span class="svg-icon svg-icon-md svg-icon-warning">
										<!--begin::Svg Icon | path:{{asset('dist/assets//media/svg/icons/Shopping/Chart-bar1.svg')}}-->
							...
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<span class="svg-icon svg-icon-md svg-icon-danger">
										<!--begin::Svg Icon | path:{{asset('dist/assets//media/svg/icons/Files/Selected-file.svg')}}-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<polygon points="0 0 24 0 24 24 0 24" />
							...
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<span class="svg-icon svg-icon-md svg-icon-primary">
										<!--begin::Svg Icon | path:{{asset('dist/assets//media/svg/icons/Communication/Mail-opened.svg')}}-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
